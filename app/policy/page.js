export default function Privacy() {
    return (
      <div className="container mx-auto px-4 py-16  bg-gradient-to-r from-blue-500 via-teal-600 to-indigo-700 text-white">
        ...
        <div className="space-y-8 text-white">
          ...
          <section>
            ...
            <p>
              Micro Sonic Work may update this Privacy Policy from time to time. Significant changes will be communicated through a notice on our website. Changes will take effect immediately upon posting.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              Email: support@microsonicwork.com <br />
              Phone: +1-800-555-1234 <br />
              Address: Micro Sonic Work, 123 Tech Drive, Innovation City, USA
            </p>
          </section>
